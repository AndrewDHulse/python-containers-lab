...
'''
students=['Andrew', 'Shane', 'Lauren', 'Selin']
...
for student_message in awesome_students:
...
shane_hates=[food for food in foods if 'a' in food]
for snack in shane_hates:
    print(shane_hates)